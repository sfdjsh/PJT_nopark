        ...
        while not rospy.is_shutdown():
            if self.is_odom == True and self.cluster_status == True:
                ...
                for num,i in enumerate(self.cluster_data.poses) :
                    ...
                    cluster_obj_data_npc.position.x = i.position.x
                    cluster_obj_data_npc.position.y = i.position.y
                    ...
                    cluster_obj_data_obstacle.position.x = i.position.x
                    cluster_obj_data_obstacle.position.y = i.position.y
